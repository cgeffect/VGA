...
- (void)newTextureAvailable:(CGMetalTexture *)inTexture {
    ...
    } else if (_alphaChannelMode == CGMetalAlphaModeLeftAlpha || _alphaChannelMode == CGMetalAlphaModeRightAlpha) {
        width = inTexture.texture.width / 2.0;
    } else if (_alphaChannelMode == CGMetalAlphaModeLeftScaleAlpha || _alphaChannelMode == CGMetalAlphaModeRightScaleAlpha) {
