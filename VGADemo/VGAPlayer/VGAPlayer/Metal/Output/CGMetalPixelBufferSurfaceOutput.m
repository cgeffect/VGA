...
- (id<MTLTexture>)newTextureBindPixelBuffer:(NSInteger)widht height:(NSInteger)height {
    ...
    CVBufferSetAttachment(_dstPixelBuffer, kCVImageBufferColorPrimariesKey,
            kCVImageBufferColorPrimaries_ITU_R_709_2, kCVAttachmentMode_ShouldPropagate);
    CVBufferSetAttachment(_dstPixelBuffer, kCVImageBufferYCbCrMatrixKey,
            kCVImageBufferYCbCrMatrix_ITU_R_601_4, kCVAttachmentMode_ShouldPropagate);
    CVBufferSetAttachment(_dstPixelBuffer, kCVImageBufferTransferFunctionKey,
